...
namespace FootballUpdateWidget
{
    ...
    class AppWidget : AppWidgetProvider
    {
        ...
        private void SetTextViewText(RemoteViews widgetView)
        {
            ...
            if (listTeamName.Count == 0)
            {
                widgetView.SetViewVisibility(Resource.Id.linearLayout7, ViewStates.Visible);
                widgetView.SetViewVisibility(Resource.Id.linearLayout2, ViewStates.Gone);
            ...
            {
                widgetView.SetViewVisibility(Resource.Id.linearLayout7, ViewStates.Gone);
                widgetView.SetViewVisibility(Resource.Id.linearLayout2, ViewStates.Visible);
                team1 = listTeamName[0];
                team1points = listTeamPoints[0];
